window.adaptStrapModules = [{
    ...
    attributeOptions: [
        ...
        },
        {
            ...
            type: 'String',
            default: 'NA',
            description: 'root path to the tree data structure example: <markdown>tree-root="data.root"</markdown>'
        },
        {
            name: 'child-node',
            required: true,
            type: 'String',
            default: 'NA',
            description: 'name of the object that contains children nodes example: <markdown>child-node="children"</markdown>'
        },
        {
